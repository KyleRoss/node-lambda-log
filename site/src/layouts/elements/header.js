...
const SiteHeader = () => {
  ...
  return (
    <Header className={`${mobileOpen ? ' open' : ''}`}>
      <nav>
        <Link plain href="/" className="brand">
        ...
        <div className="nav-menu">
          <ul>
            ...
            <li>
              <Link partiallyActive href="/docs" activeClassName="active">Documentation</Link>
            </li>
            <li className="icon">
              <Link plain href="https://github.com/KyleRoss/node-lambda-log" className="github">
                <IoLogoGithub />
